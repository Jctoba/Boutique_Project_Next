      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-black via-slate-900 to-black/80 shadow-xl backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-10 py-4 md:py-6">
          ...
          <nav className="hidden md:flex flex-1 justify-center gap-6 lg:gap-10 text-base md:text-lg font-semibold">
            <Link href="/voitures" className="text-amber-200 hover:text-amber-400 transition drop-shadow">Catalogue</Link>
            ...
            <div className="flex items-center gap-2 md:gap-4 ml-2 md:ml-8">
                ...
                <Link href="/panier" className="relative group flex items-center bg-white/20 rounded-xl p-2 px-4 md:px-6 text-amber-200 hover:text-amber-400 transition">
                <span className="hidden md:inline mr-2">Prêt?</span>
        ...
        {menuOpen && (
          <nav className="md:hidden bg-black/90 px-6 py-4 flex flex-col gap-4 text-lg font-semibold">
            <Link href="/voitures" className="text-amber-200 hover:text-amber-400 transition">Catalogue</Link>
