  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        {/* Modelo 3D y resto del contenido */}
        {/* <div className="flex justify-center mb-6 p-14">
         ...
         {/* Modelo 3D mejorado con overlay y luces de fondo */}
        ...
        <h1 className="text-5xl font-extrabold p-4 text-amber-400 drop-shadow-lg pt-114">
        ...
        <section className="text-center py-16 bg-gradient-to-b from-white to-slate-100 rounded-t-3xl mt-12 shadow-inner">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto px-4">
            ...
            <div className="flex flex-col items-center bg-white rounded-xl shadow-lg p-8 hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-lg mb-4 text-slate-700 font-medium">Disponibilité immédiate.</p>
              <button className="border border-amber-400 text-amber-500 px-6 py-2 rounded-full font-semibold hover:bg-amber-400 hover:text-white transition">
                Chercher maintenant
              </button>
            </div>
